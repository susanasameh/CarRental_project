                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('updateCar',$car->id)}}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="title" required="required" name="title" class="form-control " value={{$car->title}}>
                                    @error('title')
                                    {{ $message }}
                                @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control" name="category_id" id="">
                                        ...
                                        <option value="{{$categories->id}}" @selected(old('category_id',$car->category_id) == $categories->id)>{{$categories->categoryName}}</option>
                                        @endforeach
                                        @error('category_id')
                                        {{ $message }}
                                          @enderror
