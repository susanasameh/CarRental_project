                         ...
                         @method('put')
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="add-category" required="required" class="form-control " name="categoryName" value="{{$category->categoryName}}">
                                    @error('categoryName')
                                    {{$message}}
                                    @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button class="btn btn-primary" type="button" onclick="window.location.href='{{route('categoryTable')}}'">Cancel</button>
